...
import { deleteUserFailure, deleteUserStart, deleteUserSuccess, logoutSuccess, updateFailure, updateStart, updateSuccess } from '../../redux/user/userSlice.js';
...
export default function DashProfile() {
 ...
 const handleSubmit = async (e) => {
  ...
  if (imageFileUploading) {
    setUpdateUserError('Please wait for mage to upload')
    return;
  }
  try {
