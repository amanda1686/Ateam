  ...
  return (
    <div className=" p-3 max-w-3xl mx-auto min-h-screen">
      ...
      <form className=' flex flex-col gap-4' onSubmit={handleSubmit}>
        ...
        <TextInput type='text' placeholder='Title' requiered id='title' className=' flex-1' onChange={(e) => setFormData({...formData, title: e.target.value})}/>
        <Select
        onChange={(e) =>
        ...
        />
        <Button type='submit' gradientDuoTone='purpleToPink' className=' mb-40'>Publish</Button>
        {
